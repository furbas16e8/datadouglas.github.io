/**
 * main-11.js
 * Logic for v11 Dashboard (Splits & Vertical Stories)
 */
...
const Engine = {
    ...
    renderHeatmap: function() {
        const c = document.getElementById('heatmap-grid-sm');
        let html = '';
        for(let i=0; i<30; i++) {
            const l = Math.random() > 0.5 ? (Math.random() > 0.5 ? 2 : 1) : 0;
            html += `<div class="hm-cell l${l}"></div>`;
        }
        c.innerHTML = html;
    },
